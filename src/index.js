...
class ShipPage extends Component {
  render() {
    return (
      <div className="page">
        <p>Your ship crashed and you are about to drown. What do you do?</p>
    ...
    return (
      <div className="page">
        <p>
          ...
          <br />
          <img src="https://www.google.com/search?q=life&sxsrf=ACYBGNQvTz9DtBRVCCFqda0kG8dIPTmrHw:1569903132630&source=lnms&tbm=isch&sa=X&ved=0ahUKEwjMibX0mPrkAhVKITQIHUe2BkgQ_AUIEigB&biw=1680&bih=939#imgrc=RQySECnDAHP_rM:" />
        </p>
      </div>
    );
  }
